...
export default function About(): ReactElement {
  return (
    <>
      <SEOHead title="About | DreamIT HRM" description="채용, 교육, 성과관리, 보상, 노사관계, 조직문화 등 HRM의 모든 것을 체계적으로 학습하는 플랫폼" />
        ...
        <div className="container">
          ...
          <div style={{
            ...
            <strong style={{ fontSize: '17px', display: 'block', marginBottom: '12px' }}>
              이 사이트는 인적자원관리(HRM)의 모든 것을 체계적으로 학습하는 플랫폼입니다.
            </strong>
            <p style={{ margin: 0 }}>
              드림아이티비즈(DreamIT Biz)는 기업과 개인의 실제 니즈를 반영한 맞춤형 교육 플랫폼을 제작합니다.
              채용, 교육, 성과관리, 보상, 노사관계, 조직문화 등 HR 전 영역을 아우르는 종합 학습을 제공합니다.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '48px' }}>
            {[
              { icon: 'fa-user-plus', title: '채용 관리', desc: '효과적인 인재 확보와 채용 프로세스를 학습합니다.' },
              { icon: 'fa-graduation-cap', title: '교육·개발', desc: '직원 역량 개발과 교육 체계 설계를 다룹니다.' },
              { icon: 'fa-chart-line', title: '성과 관리', desc: 'MBO, KPI, OKR 등 성과관리 기법을 학습합니다.' },
              { icon: 'fa-handshake', title: '노사관계', desc: '건전한 노사관계와 조직문화 구축 방법을 배웁니다.' },
            ].map((item, i) => (
              <div key={i} style={{
                display: 'flex',
                gap: '16px',
